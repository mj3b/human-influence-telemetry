...
| [`0.6.5`](v0.6.5.md) | 2026-08-09 | Claim-evidence integrity audit and paper workspace | Current published release |
...
`CITATION.cff` and `.zenodo.json` identify the latest published release, currently `0.6.5`. Candidate documents may describe future versions, but they must not overwrite published-release metadata.
