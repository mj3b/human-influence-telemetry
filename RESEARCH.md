...
| E2 | Artifact evidence directly contained in the specification, schema, or case record |
| E3 | External source evidence supporting a construct or comparison |
...
|---|---|---|---|
| H1 | HIT can represent six substantive dimensions and one cross-cutting integrity dimension in one machine-readable assessment | Demonstrated by schema and fixtures once CI passes | Revise when a required finding cannot be represented |
| H2 | The 0/1/2/IE rubric distinguishes absence, ceremonial presence, substantive exercise, and missing evidence | Demonstrated for included fixtures only | Revise after external scoring or failed discrimination cases |
...
| H4 | HIT can identify oversight theater that binary human-in-the-loop labels miss | Supported by design logic and retrospective cases; not independently validated | Requires external replication |
...
| 3 | Evidenced | At least three public-record applications published |
...
The repository must state its current level based on evidence, not aspiration.
