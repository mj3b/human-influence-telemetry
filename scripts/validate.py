...
def validate() -> list[str]:
    ...
    if dois != {CONCEPT_DOI}: f.append("citation DOI boundary changed before v0.6.5 archival")
    if zenodo.get("version") != CURRENT_RELEASE or zenodo.get("upload_type") != "software": f.append("Zenodo metadata incorrect")
    phrases = {
      "README.md":["**Current release:** 0.6.5","**Human-result release:** 0.6.0","**Conformance engine version:** 0.5.0","**Current maturity:** Level 2, Applicable","10.5281/zenodo.21204892","10.5281/zenodo.21446142","7 of 7 exact agreements"],
      "RESEARCH.md":["Published repository release: `0.6.5`","Supported for one frozen Cigna packet","Level 2, Applicable"],
      ...
      "PROVENANCE.md":["Public repository release: 0.6.5","Concept DOI for all HIT software versions: 10.5281/zenodo.21204892","Version-specific software DOI for `v0.6.4`: 10.5281/zenodo.21446142","Research maturity: Level 2, Applicable"],
      ...
      "docs/releases/v0.6.5.md":["Concept DOI, all software versions","Version-specific software DOI:** Pending Zenodo archival","Human-result release:** `0.6.0`"],
